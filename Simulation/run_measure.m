...
for i=1:size(param_comb_vals, 1)
    ...
    Measurement(['output_measurement',num2str(number),'.txt'], num_levels, degree, n_offersets, max_sales, cutoff, lambda_lb, lambda_ub, mean_util_mult, n_iters, mode,number);
    counter = counter + 1;
end
end
