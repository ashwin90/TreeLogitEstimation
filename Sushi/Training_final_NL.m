function Training_final_NL(number, init_mnl)
    ...
    if init_mnl
        output_file = ['output/sushi_nl_warmstart',num2str(number),'.txt'];
    else
        output_file = ['output/sushi_nl_01start',num2str(number),'.txt'];
    end
    %mode = 'write';
    %mode = 'append';
    ...
    methods = {'fullback_mm','knitro','gdmu'};
